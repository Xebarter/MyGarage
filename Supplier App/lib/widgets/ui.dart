...
class AppMenuScope extends InheritedWidget {
  ...
  static AppMenuScope? maybeOf(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<AppMenuScope>();
  }

  @override
  bool updateShouldNotify(AppMenuScope oldWidget) => open != oldWidget.open;
}
...
class PageScaffold extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final menu = AppMenuScope.maybeOf(context);
    return AmbientBackground(
      child: Scaffold(
        backgroundColor: Colors.transparent,
        appBar: AppBar(
          automaticallyImplyLeading: false,
          leadingWidth: menu == null ? null : 60,
          leading: menu == null
              ? null
              : Padding(
