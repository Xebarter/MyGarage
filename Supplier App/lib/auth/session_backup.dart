...
/// drop the supplier on the sign-in screen.
class SessionBackup {
  SessionBackup._();

  static const staySignedInKey = 'supplier_stay_signed_in';
  static const vendorJsonKey = 'supplier_vendor_json';
  static const sessionJsonKey = 'supplier_session_json';
  static const userIdKey = 'supplier_user_id';
