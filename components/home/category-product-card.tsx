...
export function CategoryProductCard({
  ...
  return (
    <Link
      ...
      className={cn(
        'group flex h-full min-w-[9.5rem] flex-col overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm transition hover:border-primary/25 hover:shadow-md sm:min-w-[11rem]',
        className,
      )}
    >
