...
class PremiumMapController {
  ...
  void fitPoints(LatLng a, LatLng b, {double padding = 80}) {
    ...
    final pad = _padding == EdgeInsets.zero ? EdgeInsets.all(padding) : _padding;
    map.fitCamera(
      fm.CameraFit.bounds(
        ...
        fm.FlutterMap(
          ...
          children: [
            fm.TileLayer(
              ...
              userAgentPackageName: 'ug.mygarage.app',
            ),
              ...
              fm.PolylineLayer(
                polylines: [
                  for (final line in widget.polylines)
                    fm.Polyline(
                      points: [
                        for (final p in line.points) ll.LatLng(p.latitude, p.longitude),
                      ],
                      color: line.color,
