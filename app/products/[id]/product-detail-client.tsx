      ...
      <main className="bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="relative aspect-square w-full overflow-hidden rounded-lg bg-muted md:aspect-[5/4]">
              <ProductImage
                src={product.image}
                alt={product.name}
                fill
            ...
            <div>
              ...
              {variantList.length > 0 ? (
                <div className="mb-6 space-y-3">
                  <p className="text-sm font-medium text-foreground">Choose option</p>
                          ...
                          onClick={() => {
                            if (multiAxis) {
                              setVariantState({
                                ...
                                selectionByOptionId: { ...v.selections },
                              });
                            } else {
