...
const CONFIRM_RE =
  /^(yes|yep|yeah|ok|okay|sure|confirm|book it|book them|add them|add it|do it|go ahead|please book|please add|buy it|order it|checkout|check out|pay|take me there|open it|save it|add the car|update it)[\s!.]*$/i;
